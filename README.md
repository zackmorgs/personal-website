...
If you're feeling curious, `git clone https://github.com/zackmorgs/personal-website.git` this and `sudo npm install` inside the same directory package.json exists in. Installing all dependencies in root may be helpful.

This project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app) which supports hot reloading. The stylesheets are generated by [node-sass-chokidar](https://www.npmjs.com/package/node-sass-chokidar) so we can utilize it's `--watch` function to live update the stylesheets. The stylesheets start with a reasonably unopinionated reste from [normalize.css](https://necolas.github.io/normalize.css/) to normalize our styles across different browsers.

I am still finalizing a server solution but I am running a Debian installation and am hoping for an efficient solution through [serve](https://www.npmjs.com/package/serve).
